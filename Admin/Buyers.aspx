<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="Buyers.aspx.cs" Inherits="Admin_Buyers" %>
...
<form id="Form1" class="form-validate form-horizontal" runat="server">
 ...
 <div class="row">
				<div class="col-lg-12">
					<h3 class="page-header"><i class="fa fa-users"></i>Buyers</h3>
					<ol class="breadcrumb">
						<li><i class="fa fa-home"></i><a href="index.aspx">Home</a></li>
						<li><i class="fa fa-users"></i>Buyers</li>
					</ol>
				</div>
			</div>
            ...
            <Columns>
                ...
                <asp:TemplateColumn HeaderStyle-BackColor="Black">
                    ...
                    <ItemTemplate>
                      <a style="background-color:Green" class="btn btn-primary btn-sm" href='Buyers.aspx?id=<%#Eval("u_id") %>&state=<%#Eval("u_status") %>'/><%#Eval("u_status") %></a> 
                    </ItemTemplate>
                    </asp:TemplateColumn>
                 ...
                 <asp:TemplateColumn HeaderStyle-BackColor="Black">
                    ...
                    <ItemTemplate>
                      <img src='../upload/buyer/<%#Eval("u_image") %>' alt="" height="50px" width="50px" />    
                    </ItemTemplate>
                    </asp:TemplateColumn>
                  ...
                  <asp:TemplateColumn HeaderStyle-BackColor="Black">
                    ...
                    <ItemTemplate>
                    &nbsp;
                     <a  style="background-color:Red" class="btn btn-primary btn-sm" href='Buyers.aspx?id=<%#Eval("u_id") %>&state=Delete'  onClick="return confirm('Are You Sure Want to Delete..??');">Remove</a>
