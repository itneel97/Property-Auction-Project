<%@ Page Title="" Language="C#" MasterPageFile="~/Buyer/Client.master" AutoEventWireup="true" CodeFile="Joinus.aspx.cs" Inherits="Client_Joinus" %>
...
<div class="ads-grid">
               ...
               <center> <a href="Joinus.aspx" <asp:Label ID="Label7" runat="server"  style="color:#0099e5;font-size:20px" Text="My Account"></asp:Label></a> </center>
				...
				<div class="range">
               <center> <a href="Myauction.aspx" <asp:Label ID="Label4" runat="server"  style="color:#0099e5;font-size:20px" Text="My Auction"></asp:Label></a> </center>
				</div>

                	<div class="range">
               <center> <a href="Result.aspx" <asp:Label ID="Label5" runat="server"  style="color:#0099e5;font-size:20px" Text="Result"></asp:Label></a> </center>
			</div>
