...
<html lang="en">
<head>
<title>Resale_v2 a Classified ads Category Flat Bootstrap Responsive Website Template | How It Works :: w3layouts</title>
			...
			<div class="container">
				<h2 class="w3-head">How It Works</h2>
					...
					<div class="work-section-grids text-center">
						...
						<div class="clearfix"></div>
						<a class="work" href="post-ad.html">Get start Now</a>
					</div>
				</div>
		</div>	
