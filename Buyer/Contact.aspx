<%@ Page Title="" Language="C#" MasterPageFile="~/Buyer/Client.master" AutoEventWireup="true" CodeFile="Contact.aspx.cs" Inherits="Client_Contact" %>
...
<form runat="server" id="filldetails" class="submit">
					 ...
					 <asp:Button ID="Button1" ValidationGroup="a1" runat="server" Text="SEND" onclick="Button1_Click" class="button"></asp:Button>
