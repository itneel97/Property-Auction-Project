<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="Signin.aspx.cs" Inherits="Client_Signin" %>
			...
			<h2 class="w3-head"><center>Sign In</center></h2>
                ...
                <asp:TextBox ID="TextBox1" runat="server" name="Your Email" placeholder="Your Email" required=""></asp:TextBox>
                    ...
                    <div class="forgot-grid">
							...
							<a href="Forgotpassword.aspx"><center>Forgot Password?</center></a>
