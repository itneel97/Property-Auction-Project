<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="Property.aspx.cs" Inherits="Client_Property" %>
						   ...
						   <div>
                        	...
                        	<ul class="list">
                                    ...
                                    <span class="date">Expire Date: <%#Eval("p_enddate") %></span>
                                           ...
                                           <a href="Signin.aspx" class="button" 
                    style="background:#0099e5; left: 70px;top: 30px; color:White" runat="server">More</a>
