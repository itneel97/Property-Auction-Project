<%@ Page Title="" Language="C#" MasterPageFile="~/Seller/Client.master" AutoEventWireup="true" CodeFile="Addproperty.aspx.cs" Inherits="Seller_Addproperty" %>
...
<div class="w3layouts-breadcrumbs text-center">
    ...
    <div class="submit-ad main-grid-border">
		...
		<asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ...
                    <div class="clearfix"></div>
               	<asp:Button ID="Button1" runat="server" ValidationGroup="a1" Text="Submit" 
