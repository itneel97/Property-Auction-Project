...
public partial class Seller_Result : System.Web.UI.Page
{
    Admin a = new Admin();
    SqlCommand cmd;
    DataSet ds, ds1;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Label10.Text = ds.Tables[0].Rows[0]["u_name"].ToString();

            ds1 = a.select_id("result_sel_s_id", Session["uid"].ToString());
