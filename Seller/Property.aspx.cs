        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                if (state == "Category")
                {
                    ...
                    ds2 = a.select_id("seller_property_cat_id", get_id);
                    ...
                    {
                        ClientScript.RegisterStartupScript(GetType(), "alert", "alert('No Property Found In This Category..');window.location='Index.aspx'", true);
